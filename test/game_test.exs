defmodule TTTTest.Game do
  ...
  test "a win is all :X's diaganlly from top right to bottom left", %{player1: {name1, _}} = state do
  ...
  test "a win is all :O's diaganlly from top right to bottom left", %{player2: {name2, _}} = state do
